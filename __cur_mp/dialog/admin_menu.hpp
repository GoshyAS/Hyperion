class life_admin_menu {
	...
	class controls {
		...
		class TeleportMap : Life_RscButtonMenu {
			idc = 2906;
			text = "$STR_ADM_TPMap";
			onButtonClick = "[] call life_fnc_adminTpMap; hint 'Wähle wo du hin möchtest.';";
			x = 0.58 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.885;
			w = (6.25 / 40);
			h = (1 / 25);
