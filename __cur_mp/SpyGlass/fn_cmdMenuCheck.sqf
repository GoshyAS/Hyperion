...
_validMenus = [
	...
	"RscRadio","RscGroupRootMenu","RscMenuReply","RscMenuStatus","","#User:BIS_fnc_addCommMenuItem_menu","RscMenuMove","RscMenuFormations","#USER:adminmenu","#USER:ToolsMenu","#USER:ModToolsMenu","#USER:AdminToolsMenu"
];
