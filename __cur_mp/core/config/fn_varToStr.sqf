...
switch (_var) do
{
	...
	case "life_inv_crystalmeth": {(localize "STR_Item_CrystalMeth")};
	case "life_inv_crystalmethpur": {(localize "STR_Item_CrystalMethPur")};
	case "life_inv_poudrehydroxyde": {(localize "STR_Item_PoudreHydroxyde")};
	case "life_inv_zipties": {(localize "STR_Item_Zipties")};
	//URANIUM
	case "life_inv_puranium": {"Produit Uranium"};
	case "life_inv_ipuranium": {"Produit Illegal Uranium"};
	...
	//GPS Tracker
	case "life_inv_gpstracker": {"Tracer GPS"};
