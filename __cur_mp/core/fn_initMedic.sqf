...
while {true} do
    {
        ...
        (unitBackpack player) setObjectTextureGlobal [0,"textures\vetements\medic\adac_backpack.jpg"];
        waitUntil {backpack player != "B_Kitbag_cbr"};
    };
};
...
while {true} do
    {
        ...
        (unitBackpack player) setObjectTextureGlobal [0,"textures\vetements\medic\medic_backpack.jpg"];
        waitUntil {backpack player != "B_Kitbag_sgg"};
    };
};
// Backpack Skins END
