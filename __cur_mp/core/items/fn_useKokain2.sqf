...
if ( life_drugged_cocaine > 2) then
{
	...
	titleText["Tu reçois des supers pouvoirs pour 10 minutes! Fais attention à ta faim!","PLAIN"];
	...
	while{life_drugged_cocaine < 1 && Alive player} do 
	{
		...
		if(_count < 1) then {hint "Vous êtes maintenant épuisé et affaibli en raison d'une overdose! Fumer un joint ou prenner votre temps pour l'arrêter!";};
