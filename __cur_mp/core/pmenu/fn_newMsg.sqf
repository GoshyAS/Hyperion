...
switch(_type) do
{
	...
	case 1:
	{
		...
		hint format["Vous avez envoyé un message %1: %2",name life_smartphoneTarget,_msg];	
		ctrlShow[88885, true];
		closeDialog 88883;
	};
	//copmessage
	case 2:
	{
		...
		_to = "The Police";
		hint format["Vous avez envoyé un message %1: %2",_to,_msg];
	...
	case 5:
	{
		...
		hint format["Message administrateur envoyé à: %1 - Message: %2",name life_smartphoneTarget,_msg];
		closeDialog 88883;
	};
	//emergencyloading
	case 6:
	...
	case 7:
	{
		...
		hint format["Message administrateur envoyé à tous: %1",_msg];
		closeDialog 887890;
	};
};