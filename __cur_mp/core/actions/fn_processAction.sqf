...
_itemInfo = switch (_type) do
{
	...
	case "meth": {["kitmeth","poudrehydroxyde",3500,(localize "STR_Process_Meth1")];};
	case "meth1": {["poudrehydroxyde","crystalmeth",4500,(localize "STR_Process_Meth2")];};
	case "meth2": {["crystalmeth","crystalmethpur",5500,(localize "STR_Process_Meth3")];};
...
{
	if(life_hypcash < _cost) exitWith {hint format[localize "STR_Process_License",[_cost] call life_fnc_numberText]; 5 cutText ["","PLAIN"]; life_is_processing = false;};
	...
	life_hypcash = life_hypcash - _cost;
	life_is_processing = false;
};	