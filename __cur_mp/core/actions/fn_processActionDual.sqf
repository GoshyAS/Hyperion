    ...
    else
{
    ...
    if(life_hypcash < _cost) exitWith {hint format["Tu as besoin de $%1 pour le faire sans permis!",[_cost] call life_fnc_numberText]; 5 cutText ["","PLAIN"]; life_is_processing = false;};
