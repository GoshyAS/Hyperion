...
if(count _itemArray == 0) exitWith {
	[[52, player, format["%1 n'a pas d'arme.", name cursorTarget]],"TON_fnc_logIt",false,false] spawn life_fnc_MP;
};
...
titleText["Les armes et les chargeurs ont été saisis.","PLAIN"];