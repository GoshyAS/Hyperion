...
if(life_hypcash < life_ticket_val) exitWith
{
	if(life_hypatmcash < life_ticket_val) exitWith 
	{
	...
	life_hypatmcash = life_hypatmcash - life_ticket_val;
...
life_hypcash = life_hypcash - life_ticket_val;
life_ticket_paid = true;
