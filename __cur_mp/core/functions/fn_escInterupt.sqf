...
*/
private["_abortButton","_saveButton","_respawnButton","_fieldManual","_escSync","_canUseControls"];
...
while {true} do
{
	...
	_saveButton  ctrlSetText format["www.hyperiongaming.fr"];
	_fieldManual ctrlSetText format["TS3: hyperion-server.ddns.net:9991"];
