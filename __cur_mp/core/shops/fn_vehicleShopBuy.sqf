...
if(life_hypcash < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - life_hypcash] call life_fnc_numberText];};
...
life_hypcash = life_hypcash - _basePrice;
