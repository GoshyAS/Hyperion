...
{
	_cash = _betamt * _win;
	life_hypcash = life_hypcash + _cash;
...
{
	_winnings ctrlSetText "Tu perds. Le Dealer a gagné.";
	...
	_bet5KTEXT  ctrlSetText "PARI";
	_bet10KTEXT ctrlSetText "PARI";
	_bet25KTEXT ctrlSetText "PARI";
	_bet50KTEXT ctrlSetText "PARI";
